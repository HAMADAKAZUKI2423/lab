...
MEAN_PARTICIPANT_AGGREGATION = "mean_of_log10_trials"
MEDIAN_PARTICIPANT_AGGREGATION = "median_of_log10_trials"
PARTICIPANT_AGGREGATIONS = (
    MEAN_PARTICIPANT_AGGREGATION,
    MEDIAN_PARTICIPANT_AGGREGATION,
)
# 後方互換性のため、従来名は平均集約を指す。
PARTICIPANT_AGGREGATION = MEAN_PARTICIPANT_AGGREGATION
ALPHA = 0.05
