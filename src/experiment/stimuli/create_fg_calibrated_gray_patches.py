...
def generate_calibrated_gray_patches(cd_m2_levels, max_cd_m2, min_cd_m2, offset=0.0, gamma=2.2, size=(400, 300), create_images=True, base_output_dir=None):
    ...
    default_output_dir = os.path.join(lab_root, "data", "processed", "images", "pre-experiment-gabor", "fg_calibrated_gray_patches")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FG calibrated gray patch generator")
    ...
    lab_root = os.path.abspath(os.path.join(script_dir, "..", "..", ".."))
    if args.target == "main":
        csv_log_dir = os.path.join(lab_root, "results", "tables", "main-experiment-gabor", "fg_calibration_log")
        image_dir = os.path.join(lab_root, "data", "processed", "images", "main-experiment-gabor", "fg_calibrated_gray_patches")
    else:
        csv_log_dir = os.path.join(lab_root, "results", "tables", "pre-experiment-gabor", "fg_calibration_log")
        image_dir = os.path.join(lab_root, "data", "processed", "images", "pre-experiment-gabor", "fg_calibrated_gray_patches")
